...
-- Tiempo de generación: 15-04-2024 a las 03:50:49
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  `animal_eng` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nombre` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `user` (`id`, `id_rol`, `nombre`, `correo`, `telefono`, `contra`, `img`) VALUES
(1, 2, 'Juan Perez Guzman', 'juan@@gmail.com', '9512313256', 'eqweqw', 0),
(5, 3, 'Manuel Ramirez', 'manu48@gmail.com', '9514585462', ' ', 0),
(6, 3, 'Jennifer', 'Jeni@@gmail.com', '8247234', 'dfsd3423d', 0),
(24, 1, 'Omar', 'Barra', '31231231', 'rwerw', 0),
(25, 1, 'juanito alcachofa', 'juan@gmail.com', 'sadasdasd', 'sdasdasda', 0),
(30, 1, 'kevin Caballero', 'a', '1211', '123', 0),
(31, 1, 'Erik', 'erick@@gs.utm.mx', '12356788i', '1234', 0),
(34, 3, 'Kevin Caballerob Hernandez', 'kio@gmail.com', '9879812312', '$2a$10$Qhr6oAkQfEL3eO0xKMiXX.tDyQumF0MmTZjmXx4uhlJlNzRfl81iy', 0),
(35, 2, 'Juan Perez Guzman', 'juan@gmail.com', '9512313256', '$2a$10$bmYFJss1X7TzK8oqE/zkJ.HQNu/zgy586e7GbQEt0FVtiI1oGGu02', 0),
(36, 1, 'Erik', 'erick@gs.utm.mx', '12356788i', '$2a$10$7TXWnYLsRn7a7V50JODkvOBZjTj33G1m3xU/LSf1egs12T/lXx6du', 0),
(37, 1, 'Jennifer', 'Jeni@gmail.com', '8247234', '$2a$10$EDXIrwMIrxydRJAwdWlpLO6QdU2syGf99u9M.qGH/j0bPZLk91EYW', 0),
(38, 3, 'ha', 'sad', '125423652', '$2a$10$V6LZEqStQ70lbmNDIMLqQuyljU02XOlFroAPWeN/LEp07Zkf92.5O', 0),
(40, 1, 'kevin', 'gamemode948a@gmail.com', '42342342', '$2a$10$87BZIOc.KWjATdiyinRLa.2tL/afI48gcoL.a7rsp9Hl4dLQ9/mVy', 0);
